...
class DataConverterTest {
    ...
    fun initialize(){
        ...
        jsonArtistFromTrack="{\"mbid\":\"67f66c07-6e61-4026-ade5-7e782fad3a5d\",\"name\":\"Foo Fighters\",\"url\":\"https://www.last.fm/music/Foo+Fighters\"}"
    }
    ...
    fun imagesListToString_convertListOfImage_returnsSameArrayInJsonString() {
        ...
        val list= listOf(Image("https://lastfm.freetls.fastly.net/i/u/34s/2a96cbd8b46e442fc41c2b86b821562f.png","small"),
    ...
    fun artistToString_convertArtist_returnNameOfObjectOnJsonArtist() {
        val artist=dataConverter.artistToString(Artist(
            name = "Foo Fighters",
    ...
    fun testArtistToString_convertJsonFromJsonArtist_returnStringJsonWithArtistName() {
        ...
        val string=dataConverter.artistToString(Artist2(
            name = "Radiohead",
            listeners = "4847833",
            mbid="a74b1b7f-71a5-4011-9441-d0b5e4122711",
            url="https://www.last.fm/music/Radiohead",
            streamable = "0",
            image = listOf(Image("https://lastfm.freetls.fastly.net/i/u/34s/2a96cbd8b46e442fc41c2b86b821562f.png","small"))
        ))
