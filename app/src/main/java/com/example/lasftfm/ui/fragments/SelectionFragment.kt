...
class SelectionFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.tracks.setOnClickListener {
            activity?.findNavController(R.id.myNavHostFragment)?.navigate(R.id.action_selectionFragment_to_tracksFragment)
        }
        binding.artist.setOnClickListener {
            activity?.findNavController(R.id.myNavHostFragment)?.navigate(R.id.action_selectionFragment_to_artistsFragment)
        }
        return binding.root
    }
